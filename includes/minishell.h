...
/*   Updated: 2024/12/15 20:12:54 by hchouai          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char						*get_vars(const char *current_word, size_t *j,
								t_tools *tools);
char						*expand_if_dollar(const char *current_word,
								char *expanded_word, size_t *j, t_tools *tools);
char						*expand_plain2(const char *current_word,
								char *expanded_word, size_t *j);
char						*expand_single_quote(const char *current_word,
								size_t *j);
char						*expand_variable(t_tools *tools,
								const char *current_word, size_t *j);
char						*handle_single_quote(const char *current_word,
								size_t *j, int *flag);
char						*handle_double_quote(t_tools *tools,
								const char *current_word, size_t *j);
char						*handle_dollar_sign(t_tools *tools,
								const char *current_word, size_t *j,
								size_t len);
...
int							copy_and_flag_filename(t_tools *tools,
								t_lexical **temp,
								t_lexical **filename);
int							check_token(t_lexical *temp, int *heredoc_flag);
...
void						process_shell_input(t_tools **tools,
								t_lexical **tokens,
