...
/*   Updated: 2024/11/21 19:53:43 by zchtaibi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../includes/minishell.h"

static int	handle_home_path(t_tools *tools, char **path)
{
...
static int	check_cd_arg_count(t_tools *tools, t_simple_cmds *cmd)
{
	if (cmd->str[2] != NULL)
	{
...
// 	path = NULL;
// 	if (cmd->str[1] == NULL || ft_strcmp(cmd->str[1], "~") == 0)
// 	{
// 		path = get_env_value(tools->env_vars, "HOME");
// 		if (!path)
// 		{
